...
function what_coffee_is()
{
	...
	document.getElementById('coffimg').src = "https://img.freepik.com/premium-vector/holding-cup-of-hot-coffee-2d-vector-isolated-illustration_151150-6819.jpg?w=740";
	document.getElementById('cardheader').innerHTML ="К сожалению, такой кофе, вы приготовить не сможете";
	document.getElementById('cardfooter').innerHTML ="Может быть попробуете смешать что-то другое?";
	return 
}